...
<div class="writer-book-show">
    <div class="container-fluid px-0 py-2 py-lg-3">

        <div class="mb-4">
            <a href="{{ url()->previous() }}" class="writer-book-back">
        ...
        <section class="writer-book-hero">
            <div class="row g-4 g-xl-5 align-items-center">
                ...
                <div class="col-lg-8">
                    ...
                    <h1 class="writer-book-title">{{ $book->title }}</h1>
                        ...
                        @elseif($book->type === 'audio' && $book->file_path)
                            <div class="writer-book-audio">
                                <audio controls preload="metadata">
                                    <source src="{{ route('admin.books.audio', $book) }}" type="audio/mpeg">
                                </audio>
                            </div>
                        @endif

                        @if($isOwnBook)
                            <a href="{{ route('admin.books.edit', $book) }}" class="btn-secondary-action">
                                <i class="bi bi-pencil"></i>
                                Modifier
                            </a>

                            @if($book->status === 'published')
                                <a href="{{ route('admin.books.boost', $book) }}" class="btn-secondary-action">
                                    <i class="bi bi-share"></i>
                                    Booster
                                </a>
                                <a href="{{ route('admin.books.sponsor', $book) }}" class="btn-secondary-action">
        ...
        {{-- Editorial / payment notices --}}
        <div class="mt-4 d-grid gap-3">
            @if($book->status === 'draft' && $pendingPublicationPayment)
                <div class="writer-book-alert warning">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p>
                            ...
                            {{ number_format($pendingPublicationPayment->amount, 0, ',', ' ') }}
            ...
            @if($book->status === 'waiting_review' && ! $isOwnBook)
                @if($depositPaid)
                    <div class="writer-book-alert warning">
                        ...
                        <div class="flex-grow-1">
                            <strong>Prêt pour vérification éditoriale</strong>
                            <p>Le dépôt a été payé. Vous pouvez lancer la vérification.</p>
                        </div>
                ...
                @else
                    <div class="writer-book-alert warning">
                        ...
                        <div>
                            <strong>Dépôt non payé</strong>
                            <p>La vérification éditoriale sera disponible après paiement du dépôt.</p>
                        </div>
                    </div>
                @endif
            @endif
            ...
            @if($book->status === 'under_review')
                <div class="writer-book-alert warning">
                    ...
                    <div>
                        ...
                        <p>Ce livre est actuellement en cours de vérification éditoriale.</p>
                    </div>
                </div>
            @endif

            @if($book->status === 'published')
                <div class="writer-book-alert success">
                    <i class="bi bi-check-circle-fill"></i>
                    <div>
                        <strong>Livre publié</strong>
                        <p>Ce livre est disponible sur KaMa Online Library.</p>
                    </div>
                </div>
            @endif
            ...
            @if($activeSponsorship)
                <div class="writer-book-alert success">
                    ...
                    <div>
                        ...
                        <p>
                            Mis en avant jusqu’au {{ $activeSponsorship->ends_at?->format('d/m/Y') }}
