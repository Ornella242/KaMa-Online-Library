...
@section('page-title', 'Demande de retrait')
...
<main class="writer-page">
    <div class="container">
        ...
        @else
            ...
            <form method="POST" action="{{ route('admin.author.withdrawals.store') }}" id="withdrawalForm" class="writer-panel">
                @csrf
                ...
                <div class="mt-4 d-flex justify-content-end gap-2">
                    <a href="{{ route('admin.author.wallet') }}" class="btn btn-outline-secondary">Annuler</a>
