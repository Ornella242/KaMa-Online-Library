				...
				<div class="card books-container">
					...
					<div class="card-header books-header">
						<div>
							...
							<p>
								Retrouvez vos derniers ouvrages enregistrés sur KaMa.
							</p>
						</div>
					...
					<div class="card-body">
						@forelse($books as $book)
							<div class="book-item">
								...
								<div class="book-content">
									<div class="book-top">
										<div>
											...
											<div class="book-author author">
												<i class="bi bi-person-circle icon-red"></i>
												{{ Auth::user()->firstname }}
												{{ Auth::user()->lastname }}
											</div>
										</div>
									...
									<div class="book-actions">
										<!-- VIEW -->
										<a href="{{ route('writer.books.show',$book->id) }}" class="btn-view">
											<i class="bi bi-eye-fill"></i>
											Voir
										</a>
										<!-- EDIT -->
										<a href="{{ route('writer.books.edit', $book) }}" class="btn-edit">
											<i class="bi bi-pencil-square"></i>
											Modifier
										</a>
										<!-- PAYMENT -->
										@if(in_array($book->status,['draft','pending_payment']))
										<a href="{{ route('writer.books.deposit', $book->id) }}" class="btn-pay">
							...
							<div class="empty-books">
								...
								<p>
									Commencez par ajouter votre premier ouvrage KaMa.
								</p>
							</div>
						@endforelse
					</div>
