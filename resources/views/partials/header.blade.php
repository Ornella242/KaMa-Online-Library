		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbarCategoryCollapse">
				<ul class="navbar-nav navbar-nav-scroll me-auto nav-pills-primary-soft text-center ms-auto p-2 p-xl-0">
                    ...
                    <!-- Nav item Accueil -->
					<li class="nav-item"> <a class="nav-link active" href="{{ url('/') }}" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-house me-2"></i>Accueil</a></li>

					<!-- Nav item Catalogue -->
					<li class="nav-item"> <a class="nav-link" href="{{ url('/catalogue') }}" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-book me-2"></i>Catalogue</a></li>
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						...
						<li class="px-3 mb-3">
							<div class="d-flex align-items-center">
								...
								<div>
									<a class="h6 mt-2 mt-sm-0" href="index.html#">Ornella Fifa</a>
									<p class="small m-0">ornella.fifa@gmail.com</p>
								</div>
							</div>
						</li>
						...
						<li><a class="dropdown-item" href="{{ url('/book') }}"><i class="bi bi-book fa-fw me-2"></i>Mes Livres</a></li>
						<li><a class="dropdown-item" href="{{ url('/wishlist') }}"><i class="bi bi-heart fa-fw me-2"></i>Ma Liste de Souhaits</a></li>
						<li><a class="dropdown-item" href="index.html#"><i class="bi bi-gear fa-fw me-2"></i>Paramètres</a></li>
						<li><a class="dropdown-item" href="index.html#"><i class="bi bi-info-circle fa-fw me-2"></i>Centre d'Aide</a></li>
						<li><a class="dropdown-item bg-danger-soft-hover" href="index.html#"><i class="bi bi-power fa-fw me-2"></i>Déconnexion</a></li>
						<li> <hr class="dropdown-divider"></li>
